...
if(message.author.id === member.id) return message.channel.send(new Discord.MessageEmbed().setColor("#2a9df4").setTitle('Agaa beeeeeeeee!').setDescription(`O kadar yürekli olamazsın.. 🙄`))
...
.setColor("#2a9df4")
.setTitle('NovaX - Sesli Mute Sistem')
.setDescription(`
...
message.guild.channels.cache.get(logChannel).send(new Discord.MessageEmbed()
.setTitle('NovaX - Sesli  Mute Sistem').setColor("#2a9df4")
.setDescription(`
