...
.setThumbnail(message.author.displayAvatarURL({dynamic : true}))
.setImage('https://cdn.discordapp.com/attachments/739110191768928286/883839043006246972/standard.gif')
.setColor('#2a9df4')
.setDescription(` NovaX botumuzu eklemek için \`.botdavet\` yazabilirsiniz.`)  
.addField(`👉🏼 __Davet Log__`,` \`.davet-log ayarla <#kanal>\` Davet Log Kanalını Ayarlarsınız.`,true)
.addField(`👉🏼 __Davetlerim__`,` \`.davetlerim\` Davet Sayınızı Öğrenirsiniz.`,true)
